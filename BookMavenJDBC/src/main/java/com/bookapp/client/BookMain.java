				...
				case "3":
					...
					while (flag) {
						...
						case "2":
							...
							category = scanner.nextLine();
							List<Book> booksByGenre = bookService.getByCategory(category);
							if (booksByGenre != null) {
								System.out.println("Books in " + category + " are: ");
						...
						case "4":
							...
							System.out.print("Enter the genre: ");
							category = scanner.nextLine();
							List<Book> booksByAuthorAndPrice = bookService.getByAuthorContainsAndGenre(author, category);
							if (booksByAuthorAndPrice != null) {
								System.out.println("Books written by author with " + author + " and genre " + category);
