...
public class BookDaoImpl implements IBookDao {
	...
	@Override
	public List<Book> findByCategory(String category) throws BookNotFoundException, SQLException {
		try (Connection connection = DbConnection.openConnection();
	...
	@Override
	public List<Book> findByAuthorContainsAndCategory(String author, String category) throws BookNotFoundException, SQLException {
		try (Connection connection = DbConnection.openConnection();
			...
			if(!books.isEmpty())
				return books;
			throw new BookNotFoundException("No books written by author with "+author+" in name and genre of "+category);
		} finally {
			DbConnection.closeConnection();
		}
	}
