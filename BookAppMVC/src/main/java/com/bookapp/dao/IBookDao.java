...
public interface IBookDao {
	...
	List<Book> findByCategory(String category) throws BookNotFoundException, SQLException;
	List<Book> findByPriceLessThan(double price) throws BookNotFoundException, SQLException;
	List<Book> findByAuthorContainsAndCategory(String author, String category) throws BookNotFoundException, SQLException;
